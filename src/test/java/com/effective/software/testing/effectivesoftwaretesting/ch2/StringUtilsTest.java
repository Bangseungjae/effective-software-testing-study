...
import static com.effective.software.testing.effectivesoftwaretesting.ch2.StringUtils.substringsBetween;
...
class StringUtilsTest {
    ...
    @Test
    void simpleCase() {
        assertThat(substringsBetween("abcd", "a", "d")).isEqualTo(new String[]{"bc"});
    }

    @Test
    void manySubstrings() {
        assertThat(substringsBetween("abcdabcdab", "a", "d")).isEqualTo(new String[]{"bc", "bc"});
    }

    @Test
    void openAndCloseThatAreLongerThan1Char() {
        assertThat(
                substringsBetween("aabcddaabfddaab", "aa", "dd")).isEqualTo(new String[]{"bc", "bf"});
    }
